# Serenity3.0: AI-Powered Mental Health Support on Sonic 🧠⛓️
...
<div align="center">
  <img src="https://i.imghippo.com/files/uath6507iKU.png" alt="Serenity Dashboard" width="45%" />
...
1. **Clone & Install**
   ...
   ```bash
   git clone https://github.com/blocklinklabs/Serenity3.0.git
   cd Serenity3.0
   npm install
   ```
